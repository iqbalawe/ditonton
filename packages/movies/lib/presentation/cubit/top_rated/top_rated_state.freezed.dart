...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TopRatedState);
}
...
/// @nodoc
class $TopRatedStateCopyWith<$Res>  {
$TopRatedStateCopyWith(TopRatedState _, $Res Function(TopRatedState) __);
}


/// Adds pattern-matching-related methods to [TopRatedState].
extension TopRatedStatePatterns on TopRatedState {
...
class _Initial implements TopRatedState {
  const _Initial();
...
class _Loading implements TopRatedState {
  const _Loading();
...
class _Loaded implements TopRatedState {
...
/// Create a copy of TopRatedState
...
@override
String toString() {
  return 'TopRatedState.loaded(movies: $movies)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $TopRatedStateCopyWith<$Res> {
...
class _Error implements TopRatedState {
...
@override
String toString() {
  return 'TopRatedState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TopRatedStateCopyWith<$Res> {
