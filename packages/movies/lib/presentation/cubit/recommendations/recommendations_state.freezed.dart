...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecommendationsState);
}
...
/// @nodoc
class $RecommendationsStateCopyWith<$Res>  {
$RecommendationsStateCopyWith(RecommendationsState _, $Res Function(RecommendationsState) __);
}
...
class _Initial implements RecommendationsState {
  const _Initial();
...
class _Loading implements RecommendationsState {
  const _Loading();
...
class _Loaded implements RecommendationsState {
...
@override
String toString() {
  return 'RecommendationsState.loaded(movies: $movies)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $RecommendationsStateCopyWith<$Res> {
...
class _Empty implements RecommendationsState {
  const _Empty();
...
@override
String toString() {
  return 'RecommendationsState.empty()';
}
...
class _Error implements RecommendationsState {
...
@override
String toString() {
  return 'RecommendationsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RecommendationsStateCopyWith<$Res> {
