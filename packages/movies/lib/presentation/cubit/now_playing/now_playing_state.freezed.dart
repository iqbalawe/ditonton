...
class _Initial implements NowPlayingState {
  const _Initial();
...
class _Loading implements NowPlayingState {
  const _Loading();
...
class _Loaded implements NowPlayingState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $NowPlayingStateCopyWith<$Res> {
...
class _Error implements NowPlayingState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $NowPlayingStateCopyWith<$Res> {
