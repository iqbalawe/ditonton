...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WatchlistMoviesState);
}
...
/// @nodoc
class $WatchlistMoviesStateCopyWith<$Res>  {
$WatchlistMoviesStateCopyWith(WatchlistMoviesState _, $Res Function(WatchlistMoviesState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Movie> movies)?  loaded,TResult Function()?  empty,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Movie> movies)  loaded,required TResult Function()  empty,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Movie> movies)?  loaded,TResult? Function()?  empty,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Initial implements WatchlistMoviesState {
  const _Initial();
...
@override
String toString() {
  return 'WatchlistMoviesState.initial()';
}
...
class _Loading implements WatchlistMoviesState {
  const _Loading();
...
@override
String toString() {
  return 'WatchlistMoviesState.loading()';
}
...
class _Loaded implements WatchlistMoviesState {
...
@override
String toString() {
  return 'WatchlistMoviesState.loaded(movies: $movies)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $WatchlistMoviesStateCopyWith<$Res> {
...
class _Empty implements WatchlistMoviesState {
  const _Empty();
...
@override
String toString() {
  return 'WatchlistMoviesState.empty()';
}
...
class _Error implements WatchlistMoviesState {
...
@override
String toString() {
  return 'WatchlistMoviesState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $WatchlistMoviesStateCopyWith<$Res> {
