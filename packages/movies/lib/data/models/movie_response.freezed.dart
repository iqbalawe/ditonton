...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<MovieModel> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MovieResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<MovieModel> results)  $default,) {final _that = this;
switch (_that) {
case _MovieResponse():
return $default(_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<MovieModel> results)?  $default,) {final _that = this;
switch (_that) {
case _MovieResponse() when $default != null:
return $default(_that.results);case _:
  return null;
...
class _MovieResponse implements MovieResponse {
  const _MovieResponse({required final  List<MovieModel> results}): _results = results;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieResponse&&const DeepCollectionEquality().equals(other._results, _results));
}
