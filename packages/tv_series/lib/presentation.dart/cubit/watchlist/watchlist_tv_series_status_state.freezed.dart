...
part of 'watchlist_tv_series_status_state.dart';
...
/// @nodoc
mixin _$WatchlistTVSeriesStatusState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WatchlistTVSeriesStatusState);
}
...
/// @nodoc
class $WatchlistTVSeriesStatusStateCopyWith<$Res>  {
$WatchlistTVSeriesStatusStateCopyWith(WatchlistTVSeriesStatusState _, $Res Function(WatchlistTVSeriesStatusState) __);
}


/// Adds pattern-matching-related methods to [WatchlistTVSeriesStatusState].
extension WatchlistTVSeriesStatusStatePatterns on WatchlistTVSeriesStatusState {
...
class _Initial implements WatchlistTVSeriesStatusState {
  const _Initial();
...
@override
String toString() {
  return 'WatchlistTVSeriesStatusState.initial()';
}
...
class _Loading implements WatchlistTVSeriesStatusState {
  const _Loading();
...
@override
String toString() {
  return 'WatchlistTVSeriesStatusState.loading()';
}
...
class _IsAdded implements WatchlistTVSeriesStatusState {
  const _IsAdded(this.isAdded);
  

 final  bool isAdded;

/// Create a copy of WatchlistTVSeriesStatusState
...
@override
String toString() {
  return 'WatchlistTVSeriesStatusState.isAdded(isAdded: $isAdded)';
}
...
/// @nodoc
abstract mixin class _$IsAddedCopyWith<$Res> implements $WatchlistTVSeriesStatusStateCopyWith<$Res> {
...
class _Message implements WatchlistTVSeriesStatusState {
...
@override
String toString() {
  return 'WatchlistTVSeriesStatusState.message(message: $message)';
}
...
/// @nodoc
abstract mixin class _$MessageCopyWith<$Res> implements $WatchlistTVSeriesStatusStateCopyWith<$Res> {
