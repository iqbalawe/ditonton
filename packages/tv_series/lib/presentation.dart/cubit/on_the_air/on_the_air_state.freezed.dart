...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OnTheAirState);
}
...
/// @nodoc
class $OnTheAirStateCopyWith<$Res>  {
$OnTheAirStateCopyWith(OnTheAirState _, $Res Function(OnTheAirState) __);
}


/// Adds pattern-matching-related methods to [OnTheAirState].
extension OnTheAirStatePatterns on OnTheAirState {
...
class _Initial implements OnTheAirState {
  const _Initial();
...
class _Loading implements OnTheAirState {
  const _Loading();
...
class _Loaded implements OnTheAirState {
  const _Loaded(final  List<TVSeries> tvSeries): _tvSeries = tvSeries;
...
@override
String toString() {
  return 'OnTheAirState.loaded(tvSeries: $tvSeries)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $OnTheAirStateCopyWith<$Res> {
...
null == tvSeries ? _self._tvSeries : tvSeries // ignore: cast_nullable_to_non_nullable
as List<TVSeries>,
  ));
}
...
class _Error implements OnTheAirState {
...
@override
String toString() {
  return 'OnTheAirState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OnTheAirStateCopyWith<$Res> {
